...
│   ├── fizzbuzz                  # Print the numbers from 1 to n following the FizzBuzz rules
...
│   ├── palindromesentence        # Checks if a sentence is a palindrome
...
└── poo/                          
    ...
    ├── usedproduct               # Different product types with polimorfism
